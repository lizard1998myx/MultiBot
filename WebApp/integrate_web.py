from MultiBot.WebApp.web_app import WebAppPorter
from MultiBot.WCPublic.wcp_flask import WCPublicPorter, WCP_TOKEN
...
def upload():
    ...
    if flask.request.method == 'POST':
        ...
        upload_path = os.path.join(os.path.abspath('..'), 'temp',
