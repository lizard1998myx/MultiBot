...
INTRODUCTION = {'Default': "你好！我是MultiBot（V%s）。"
                ...
                'WCP': "你好！我是公众平台上的MultiBot，目前兼职国台研会的后台机器人。"
                       "回复“联谊”查看国科大联谊活动留言，你也可以试试“北京疫情”来查看风险区域。",
                ...
                'WebApp': "你好！我是网页上的MultiBot，这里连接稳定，支持图文回复。"
                          "回复“更多”了解详情，回复“帮助”查看使用指南，回复“填报”部署疫情填报，"
                          "回复“国台填报”部署疫情填报（国台版），回复“申报”进行行程申报。"}
...
Wechat：用Wechaty实现的微信交互，功能基本完善
WebApp：用Flask实现的网页交互，只接收文本，但可以返回图片

[网址]
标准版：http://106.12.190.219/
远程打印（已关闭）：http://106.12.190.219/upload/
