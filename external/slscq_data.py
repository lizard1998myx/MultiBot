...
SLSCQ_DATA = {
    ...
    "verb":
        [
            ...
            "加快", "振兴", "扶持", "改善", "调整", "优化", "解决", "宣传", "教育", "发挥", "支持", "带动", "帮助", "深化", "规范", "强化", "统筹", "指导",
            "服务", "健全", "确保", "维护", "优先", "贯彻", "实施", "深化", "保证", "鼓励", "引导", "坚持", "深化", "强化", "监督", "管理", "开展", "规划",
            "整合", "理顺", "推行", "纠正", "满足", "推广", "遏制", "整治", "保护", "健全", "丰富", "夯实", "统一", "尊重", "制约", "适应", "发扬", "拓宽",
            "拓展", "规范", "改进", "形成", "逐步", "实现", "规范", "坚持", "调节", "取缔", "调控", "把握", "弘扬", "借鉴", "倡导", "培育", "打牢", "武装",
            "凝聚", "激发", "说服", "感召", "尊重", "包容", "树立", "培育", "发扬", "提倡", "营造", "促进", "唱响", "主张", "弘扬", "通达", "发展", "疏导",
            "着眼", "吸引", "塑造", "搞好", "履行", "倾斜", "惠及", "简化", "衔接", "调处", "关切", "汇集", "分析", "排查", "协商", "化解", "动员", "联动",
            "激发", "增进", "汲取", "检验", "保护", "鼓励", "完善", "宽容", "增强", "融洽", "凝聚", "汇集", "筑牢", "考验", "进取", "凝聚", "设置", "吸纳",
            "造就", "聚焦", "支撑", "展现", "体现", "分析", "研究", "了解", "掌握", "发现", "提出", "推进", "推动", "制定", "出台", "完善", "建立", "健全",
            "加强", "强化", "增强", "促进", "加深", "深化", "扩大", "落实", "细化", "突出", "建设", "营造", "开展", "发挥", "发扬", "创新", "转变", "发展",
            "统一", "提高", "提升", "保持", "优化", "召开", "举行", "贯彻", "执行", "树立", "引导", "规范", "整顿", "服务", "协调", "沟通", "配合", "合作",
            "支持", "加大", "开拓", "拓展", "巩固", "保障", "保证", "形成", "指导"
        ],
    "noun":
        [
            "关系", "力度", "速度", "反映", "诉求", "形势", "任务", "本质属性", "总体布局", "战略任务", "内在要求", "重要进展", "决策部署", "结合点", "突出地位",
            "最大限度", "指导思想", "科学性", "协调性", "体制机制", "基本方略", "理念意识", "基本路线", "基本纲领", "秩序", "基本经验", "出发点", "落脚点", "要务",
            "核心", "主体", "积极因素", "水平", "方针", "结构", "增量", "比重", "规模", "标准", "办法", "主体", "作用", "特色", "差距", "渠道", "方式",
            "主导", "纽带", "主体", "载体", "制度", "需求", "能力", "负担", "体系", "重点", "资源", "职能", "倾向", "秩序", "途径", "活力", "项目", "工程",
            "政策", "项目", "竞争力", "环境", "素质", "权利", "利益", "权威", "氛围", "职能", "作用", "事权", "需要", "能力", "基础", "比重", "长效机制",
            "举措", "要素", "精神", "根本", "地位", "成果", "核心", "精神", "力量", "纽带", "思想", "理想", "活力", "信念", "信心", "风尚", "意识", "主旋律",
            "正气", "热点", "情绪", "内涵", "管理", "格局", "准则", "网络", "稳定", "安全", "支撑", "局面", "环境", "本领", "位置", "敏锐性", "针对性",
            "有效性", "覆盖面", "特点", "规律", "阵地", "政策", "措施", "制度保障", "任务", "体系", "机制", "体制", "系统", "规划", "战略", "方针", "政策",
            "措施", "要点", "重点", "焦点", "难点", "热点", "亮点", "矛盾", "问题", "建设", "思想", "认识", "作风", "整治", "环境", "秩序", "作用", "地方",
            "基层", "传统", "运行", "监测", "监控", "调控", "监督", "工程", "计划", "行动", "创新", "增长", "方式", "模式", "转变", "质量", "水平", "效益",
            "会议", "文件", "精神", "意识", "服务", "协调", "沟通", "力度", "领域", "空间", "成绩", "成就", "进展", "实效", "基础", "前提", "关键", "保障",
            "动力", "条件", "环节", "方法", "思路", "设想", "途径", "道路", "主意", "办法", "力气", "功夫", "台阶", "形势", "情况", "意见", "建议", "网络",
            "指导", "指南", "目录", "方案"
        ],
    "adverb_1":
        [
    ...
    "phrase":
        [
            "立足当前", "着眼长远", "抓住机遇", "应对挑战", "突出重点", "分步实施", "全面推进", "统筹兼顾", "综合治理", "融入其中", "贯穿始终", "切实抓好", "扎实推进",
            "加快发展", "持续增收", "积极稳妥", "狠抓落实", "从严控制", "严格执行", "坚决制止", "明确职责", "高举旗帜", "坚定不移", "牢牢把握", "积极争取", "深入开展",
            "注重强化", "规范程序", "改进作风", "积极发展", "努力建设", "依法实行", "良性互动", "优势互补", "率先发展", "互惠互利", "做深、做细、做实", "全面分析", "全面贯彻",
            "持续推进", "全面落实、全面实施", "逐步扭转", "基本形成", "普遍增加", "基本建立", "更加完备", "逐步完善", "明显提高", "逐渐好转", "逐步形成", "不断加强", "持续增效",
            "巩固深化", "大幅提高", "显著改善", "不断增强", "日趋完善", "比较圆满", "统一思想", "提高认识", "认清形势", "明确任务", "加强领导", "完善机制", "交流经验",
            "研究问题", "团结协作", "密切配合", "真抓实干拓进取", "突出重点", "落实责任", "各司其职", "各负其责", "集中精力", "聚精会神", "一心一意", "心无旁骛", "兢兢业业",
            "精益求精", "一抓到底", "爱岗敬业", "求真务实", "胸怀全局", "拓宽视野"
        ],
    "sentence":
        [
            "“足寒伤心，民寒伤国。”",
